<div>
    ...
    <div class="flex flex-col items-center justify-center min-h-screen py-2 font-serif"
        ...
        <div class="flex flex-col md:flex-row items-center justify-center w-full min-h-screen">
            <div class="p-4">
                <img src="{{ asset('img/PP1.jpg') }}" alt="Profile Image" class="rounded-full img-hover w-[300px] ">
            </div>
            <div class="md:w-1/2 text-center p-4">
                ...
                <p class="text-xl text-gray-200 typing-text">
                    ...
                    back-end web applications. My expertise lies in PHP, Laravel, Livewire, and Tailwind CSS, enabling
                    me to build modern and efficient web solutions.
                </p>
            </div>
        </div>
        <!-- Skills -->
        <div id="myComponent" class="flex flex-col md:flex-row items-center justify-center w-full">
            <div class="bg-gray-950 p-4 rounded-lg w-[400px] text-white m-4">
                ...
                <div class="h-2 bg-purple-900 rounded-full mt-2">
                    <div class="h-full progress-bar bg-purple-500 rounded-full" style="width: 80%;"></div>
                </div>
                ...
                <div class="h-2 bg-purple-900 rounded-full mt-2">
                    <div class="h-full progress-bar bg-purple-500 rounded-full" style="width: 70%;"></div>
                </div>
                <div class="flex items-center justify-between mt-4">
                ...
                <div class="h-2 bg-purple-900 rounded-full mt-2">
                    <div class="h-full progress-bar bg-purple-500 rounded-full" style="width: 50%;"></div>
                </div>
                <div class="flex items-center justify-between mt-4">
            ...
            <div class="bg-gray-950 p-4 rounded-lg w-[400px] text-white m-4">
                ...
                <div class="h-2 bg-purple-900 rounded-full mt-2">
                    <div class="h-full progress-bar bg-purple-500 rounded-full" style="width: 65%;"></div>
                </div>
                <div class="flex items-center justify-between mt-4">
