<div>
    <div>
        ...
        <div class="flex flex-col items-center justify-center min-h-screen py-2 font-serif"
            ...
            <div class="flex">
                <div class="text-white w-full p-8 rounded overflow-hidden shadow-lg bg-gray-900">
                    ...
                    <form action="/contactme" method="POST" class="mb-4">
                        ...
                        <input type="text" name="name" class="bg-gray-800 text-white px-3 py-1 mr-1 rounded w-full mb-2"
                            placeholder="Your Name" required>
                        <label for="email" class="block mb-2">Email:</label>
                        <input type="email" name="email"
                            class="bg-gray-800 text-white px-3 py-1 mr-1 rounded w-full mb-2" placeholder="Your Email"
                            required>
                ...
                <div class="flex flex-col bg-white p-2 items-center justify-center min-h-screen w-[500px] rounded">
                    <div class="shadow-md rounded m-4">
                        <div class="mb-4">
                            <label class="block text-gray-600 text-3xl font-bold mb-4 ml-4" for="pdf">
                                My CV
                            </label>
                            <object data="{{ asset('./pdf/CV.pdf') }} " width="500px" height="500px"
